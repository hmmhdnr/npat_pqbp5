...
## datasets
A source data is attached as a source data of this analysis in MS excel file named "Confirmation_of_SNP_GWAS_data_and_polyQ_disease_association_dataset.xlsx".
